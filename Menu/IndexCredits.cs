...
{
    class IndexCredits:BasicIndex
    {
        public IndexCredits(Vector2 position, int numSprite, float fps, float verticalMaxSpeed, float horizontalMaxSpeed)
        {
            //value
            ...
            {
                sprites[i] = "Assets/cmd/credits/" + i + ".png";
            }
